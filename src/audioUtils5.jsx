...
const AudioSelectorPage12 = ({ audioPathPage12, setAudioPathPage12 }) => {
  useEffect(() => {
    if (!audioPathPage12) {
      ...
      "Les_feuilles_mortes_Jean-Michel_Blais_Matthias_&_Maxime_sample_2.mp3",
      ...
      "Limpeza_Pesada_Mateus_Alves,_Tomaz_Alves_Souza_Bacurau_sample_2.mp3",
      ...
      "Little_Women_-_Robert_Schumann_-_Kinderszenen_op.15_I._Von_Fremden_Landern_und_Menschen_sample_2.mp3",
      "Loneliness_#3_(Night_Talking)_Arcade_Fire_Owen_Pallett_Her_sample_1.mp3",
      "Loneliness_#3_(Night_Talking)_Arcade_Fire_Owen_Pallett_Her_sample_2.mp3",
      ...
      "Ludovico_Einaudi_Low_Mist_Var.2_(Day_1)__The_Father_sample_1.mp3",
      "Ludovico_Einaudi_Low_Mist_Var.2_(Day_1)__The_Father_sample_2.mp3",
      "Ludovico_Einaudi_Cold_Wind_Var.2_(Day_4)_The_Father_sample_1.mp3",
      "Ludovico_Einaudi_Cold_Wind_Var.2_(Day_4)_The_Father_sample_2.mp3",
      ...
      "Ludwig_Goransson_T'Challa_Black_Panther_Wakanda_Forever_sample_2.mp3",
      "Main_Theme_Terence_Blanchard_BlacKkKlansman_sample_1.mp3",
      "Main_Theme_Terence_Blanchard_BlacKkKlansman_sample_2.mp3",
      "Marco_Beltrami,_Buck_Sanders_-_Le_Mans_66_Ford_v_Ferrari_sample_1.mp3",
      "Marco_Beltrami,_Buck_Sanders_-_Le_Mans_66_Ford_v_Ferrari_sample_2.mp3",
