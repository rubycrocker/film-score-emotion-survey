...
const AudioSelectorPage11 = ({ audioPathPage11, setAudioPathPage11 }) => {
  useEffect(() => {
    if (!audioPathPage11) {
      ...
      "Hungry Spirit_Cornel_Wilczek_Thomas_E_Rouch_Talk_To_Me_sample_2.mp3",
      ...
      "In_Motion_-_Trent Reznor_and_Atticus Ross_The_Social_Network_sample_2.mp3",
      ...
      "Is_That_What_Everybody_Wants_Cliff Martinez_Solaris_sample_2.mp3",
