    ...
    <>
      {currentPage === 'page1' && (
        <div className="page" id="page1">
          ...
          <img src={process.env.PUBLIC_URL + '/img/aimlogo.png'} style={{ width: '100px', height: 'auto', float: 'right', padding: '10px'}} />
          <img src={process.env.PUBLIC_URL + '/img/qmullogo.jpeg'} style={{ width: '200px', height: 'auto', float: 'left', padding: '10px'}} />
          <p>  </p>
          <br></br>
