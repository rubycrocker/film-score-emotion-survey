...
const AudioSelectorPage10 = ({ audioPathPage10, setAudioPathPage10 }) => {
  useEffect(() => {
    if (!audioPathPage10) {
      ...
      "Emile_Mosseri_–_Big Country_Minari_sample_2.mp3",
      ...
      "Fare_Thee_Well_(Dink's Song)_Oscar_Isaac_Marcus_Mumford_Inside_Llewyn_Davis_sample_2.mp3",
      ...
      "Hand_Covers_Bruise_Trent Reznor_and_Atticus Ross_The_Social_Network_sample_2.mp3",
